  ...
  return (
    <SafeAreaView style={appStyles.container}>
      ...
      <View style={appStyles.mainview}>
       ...
       These terms and conditions (the "Terms and Conditions") govern the use of www.harvestyards.com (the "Site"). This Site is owned and operated by Knot for Profit. This Site is an app for Android and Apple iOS.{'\n'}{'\n'}By using this Site, you indicate that you have read and understand these Terms and Conditions and agree to abide by them at all times.{'\n'}{'\n'}THESE TERMS AND CONDITIONS CONTAIN A DISPUTE RESOLUTION CLAUSE THAT IMPACTS YOUR RIGHTS ABOUT HOW TO RESOLVE DISPUTES. PLEASE READ IT CAREFULLY.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Intellectual Property</Text>{'\n'}All content published and made available on our Site is the property of Knot for Profit and the Site's creators. This includes, but is not limited to images, text, logos, documents, downloadable files and anything that contributes to the composition of our Site.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Age Restrictions</Text>{'\n'}The minimum age to use our Site is 13 years old. By using this Site, users agree that they are over 13 years old. We do not assume any legal responsibility for false statements about age.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Acceptable Use</Text>{'\n'}As a user of our Site, you agree to use our Site legally, not to use our Site for illegal purposes, and not to:{'\n'}
...
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Third Party Goods and Services</Text>{'\n'}Our Site may offer goods and services from third parties. We cannot guarantee the quality or accuracy of goods and services made available by third parties on our Site.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>User Goods and Services</Text>{'\n'}Our Site allows users to sell goods and services. We do not assume any responsibility for the goods and services users sell on our Site. We cannot guarantee the quality or accuracy of any goods and services sold by users on our Site. However, if we are made aware that a user is violating these Terms and Conditions, we reserve the right to suspend or prohibit the user from selling goods and services on our Site.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Links to Other Websites</Text>{'\n'}Our Site contains links to third party websites or services that we do not own or control. We are not responsible for the content, policies, or practices of any third party website or service linked to on our Site. It is your responsibility to read the terms and conditions and privacy policies of these third party websites before using these sites.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Limitation of Liability</Text>{'\n'}Knot for Profit and our directors, officers, agents, employees, subsidiaries, and affiliates will not be liable for any actions, claims, losses, damages, liabilities and expenses including legal fees from your use of the Site.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Indemnity</Text>{'\n'}Except where prohibited by law, by using this Site you indemnify and hold harmless Knot for Profit and our directors, officers, agents, employees, subsidiaries, and affiliates from any actions, claims, losses, damages, liabilities and expenses including legal fees arising out of your use of our Site or your violation of these Terms and Conditions.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Applicable Law</Text>{'\n'}These Terms and Conditions are governed by the laws of the State of California.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Dispute Resolution</Text>{'\n'}Subject to any exceptions specified in these Terms and Conditions, if you and Knot for Profit are unable to resolve any dispute through informal discussion, then you and Knot for Profit agree to submit the issue first before a non-binding mediator and to an arbitrator in the event that mediation fails. The decision of the arbitrator will be final and binding. Any mediator or arbitrator must be a neutral party acceptable to both you and Knot for Profit.{'\n'}{'\n'}
Notwithstanding any other provision in these Terms and Conditions, you and Knot for Profit agree that you both retain the right to bring an action in small claims court and to bring an action for injunctive relief or intellectual property infringement.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Severability</Text>{'\n'}If at any time any of the provisions set forth in these Terms and Conditions are found to be inconsistent or invalid under applicable laws, those provisions will be deemed void and will be removed from these Terms and Conditions. All other provisions will not be affected by the removal and the rest of these Terms and Conditions will still be considered valid.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Changes</Text>{'\n'}These Terms and Conditions may be amended from time to time in order to maintain compliance with the law and to reflect any changes to the way we operate our Site and the way we expect users to behave on our Site. We will notify users by email of changes to these Terms and Conditions or post a notice on our Site.{'\n'}{'\n'}
<Text style={[appStyles.title,{textDecorationLine:'underline'}]}>Contact Details</Text>{'\n'}Please contact us if you have any questions or concerns. Our contact details are as follows: admin@harvestyards.com 8549 Wilshire Blvd., #2021, Beverly Hills, CA 90211{'\n'}{'\n'}
Effective Date: 4th day of November, 2023
*************************************************************{'\n'}
<Text style={appStyles.title}>Privacy Policy</Text>{'\n'}{'\n'}
...
<Text style={appStyles.title}>Interpretation</Text>{'\n'}{'\n'}
The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.{'\n'}{'\n'}
<Text style={appStyles.title}>Definitions</Text>{'\n'}{'\n'}
...
The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:{'\n'}{'\n'}
    ...
    <Text style={appStyles.title}>ecurity of Your Personal Data</Text>{'\n'}{'\n'}
...
Please note that the categories and examples provided in the list below are those defined in the CCPA/CPRA. This does not mean that all examples of that category of personal information were in fact collected by Us, but reflects our good faith belief to the best of Our knowledge that some of that information from the applicable category may be and may have been collected. For example, certain categories of personal information would only be collected if You provided such personal information directly to Us.{'\n'}{'\n'}
	•	Category A: Identifiers.E{'\n'}xamples: A real name, alias, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, driver's license number, passport number, or other similar identifiers.{'\n'}Collected: Yes.{'\n'}
