  ...
  return (
    <SafeAreaView style={appStyles.container}>
      ...
      <ScrollView
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('LocationRadious')}>
          <View
            style={[
              appStyles.getdirectioncontainer,
              {
        ...
        <Text style={[appStyles.infotxt, {marginTop: responsiveHeight(5)}]}>
          Selected
        </Text>
        {selectedLocation && (
          // <TouchableOpacity
      ...
      <TouchableOpacity onPress={() => setHelpCalloutModalVisible(true)}>
        <Image
          source={HelpCallout}
          style={[appStyles.helpview, {width: scale(60), height: scale(60)}]}
        />
      </TouchableOpacity>
      <HelpCalloutModal
