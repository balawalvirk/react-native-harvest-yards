...
const QRcodeModal = ({
  ...
  const imageUri =
    'nxY6upyayHZXDVRMsiAysdy6ZUE2_Web Development_Sun Dec 10 2023 20:19:00 GMT+0500';
  ...
  return (
    <Modal
      ...
      <View style={[appStyles.QRmodal, {height: scale(480)}]}>
        <Text style={[appStyles.modalText1, {marginTop: responsiveHeight(2)}]}>
          Food Reserved!
        </Text>
        <View style={appStyles.qrsecondcode}>
          <Text
            style={[appStyles.modalText2, {marginTop: responsiveHeight(2)}]}>
            Your food has been reserved successfully.Use the QR{'\n'}code below
            to collect the food from the Food Center.
            {'\n'}You can also access this QR code from the Reserved
          </Text>
          <Text style={[appStyles.modalText2, {alignSelf: 'center'}]}>
            Food tab.
          </Text>
        </View>
        <View style={{alignSelf: 'center', marginTop: responsiveHeight(3)}}>
          <QRCode value={qrCodeValue} size={150} getRef={qrCodeRef} />
        </View>

        <Text
          style={[
            appStyles.title,
            {alignSelf: 'center', marginTop: responsiveHeight(1)},
          ]}>
          ID# {_id.slice(-4)}
        </Text>
        <TouchableOpacity
          style={[
            ...
            {marginTop: responsiveHeight(2), width: responsiveWidth(85)},
          ]}
